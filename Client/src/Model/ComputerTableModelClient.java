...
public class ComputerTableModelClient extends AbstractTableModel {
    ...
    public ComputerTableModelClient(List<Socket> list) {
        this.list = list;
    ...
    public void updateAllElement() {
        ...
        try {
            for (Socket s : list) {
                if (DataUtilsCLient.checkConnectClosed(s)) {
                    list.remove(i);
